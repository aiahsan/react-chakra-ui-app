...
import NewNoteBook from './createNotebookModal'
  ...
  return (
    ...
    <Modal isOpen={props.isOpen} onClose={props.onClose}>
      ...
      <ModalContent width="100%" maxWidth=" 601px">
        <Box w="100%" h="324px" maxW="601px" padding="22px 30px 0px 30px">
   ...
   _focus={{
    ...
    borderColor: "#ADADAD",
          ...
          <Flex marginTop="31px" alignItems="center">
            ...
            <MenuButton title="8 Go - $0.10/Hour" />
          </Flex>
          ...
          >
            ...
            <Box>
              <Button
              variant={value!==""?"priceButton":"priceButtonDisabled"}
                width="101px"
...
<NewNoteBook isOpen={isOpen} onClose={()=>setisOpen(false)}/>
    </>
  );
};
